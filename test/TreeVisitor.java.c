...
int Visitor_visit(struct Visitor * this, struct Tree * n)
{
  ...
  if ((x_79=n, x_79->vptr->GetHas_Right(x_79))){
    r = (x_80=n, x_80->vptr->GetRight(x_80));
    nti = (x_81=r, x_81->vptr->accept(x_81, this));
  }
  else
    nti = 0;
  if ((x_82=n, x_82->vptr->GetHas_Left(x_82))){
    l = (x_83=n, x_83->vptr->GetLeft(x_83));
    nti = (x_84=l, x_84->vptr->accept(x_84, this));
  }
  else
    nti = 0;
  return 0;
...
int MyVisitor_visit(struct MyVisitor * this, struct Tree * n)
{
  ...
  if ((x_85=n, x_85->vptr->GetHas_Right(x_85))){
    r = (x_86=n, x_86->vptr->GetRight(x_86));
    nti = (x_87=r, x_87->vptr->accept(x_87, this));
  }
  else
    nti = 0;
  System_out_println ((x_88=n, x_88->vptr->GetKey(x_88)));
  if ((x_89=n, x_89->vptr->GetHas_Left(x_89))){
    l = (x_90=n, x_90->vptr->GetLeft(x_90));
    nti = (x_91=l, x_91->vptr->accept(x_91, this));
  }
  else
    nti = 0;
  return 0;
