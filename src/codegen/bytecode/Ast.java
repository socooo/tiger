...
public class Ast {
    ...
    public static class Stm {
        ...
        public static class GetField extends T {
            ...
            public GetField(String className, String fieldName, Type.T fieldType) {
        ...
        public static class PutField extends T {
            ...
            String fieldName;
            Type.T fieldType;
            public PutField(String className, String fieldName, Type.T fieldType) {
                this.className = className;
                this.fieldName = fieldName;
                this.fieldType = fieldType;
            }
