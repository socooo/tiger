...
public class Ast {
    ...
    /*public static class Epsilon{
        public static class Eps implements Acceptable{
    ...
    public static class Type {
        ...
        public static class ClassType extends T {
            ...
            public ClassType(String id, int lineNum) {
                this.id = id;
                this.lineNum = lineNum;
            }
    ...
    public static class Exp {
        ...
        public static class Id extends T {
            ...
            public Id(String id, boolean isField, int lineNum) {
                this.lineNum = lineNum;
                this.id = id;
                this.type = null;
                this.isField = false;
    ...
    public static class Stm {
        ...
        public static class Assign extends T {
            ...
            public Assign(Exp.Id id, Exp.T exp, int lineNum) {
                this.lineNum = lineNum;
                this.id = id;
                this.exp = exp;
                this.type = null;
        ...
        public static class AssignArray extends T {
            ...
            public AssignArray(Exp.Id id, Exp.T index, Exp.T exp, int lineNum) {
                this.lineNum = lineNum;
                this.id = id;
                this.index = index;
                this.exp = exp;
    ...
    public static class Program {
        ...
        public static class ProgramSingle extends T {
            ...
            public ProgramSingle(MainClass.T mainClass, LinkedList<Class.T> classes, int lineNum) {
                this.lineNum = lineNum;
